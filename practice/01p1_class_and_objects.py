...
class Book:
    ...
    def turn_page(self):
        if self.current_page < self.total_pages:
            ...
            print("Can't turn page, you're already at the end")

    def current_status(self):
        return f"Reading {self.title} by {self.author}. Currently on page {self.current_page} of {self.total_pages}."

book_1 = Book("Pride and Prejudice", "Jane Austen", 500)
book_2 = Book("Ender's Game", "Orson Scott Card", 400)
...
for book_object in list_of_books:
    print(book_object.current_status())
import random

random_book = random.choice(list_of_books)
print(list_of_books)
list_of_books.remove(random_book)
print(list_of_books)
...
PART 3:
    Put both of the books you made into a list.
    Theen loop through the list and run the current_status() method on each.
