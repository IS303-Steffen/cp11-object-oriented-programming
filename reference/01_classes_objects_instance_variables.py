...
class Dog: # name of the class
    ...
    # This is the Constructor/Initializer. It MUST be called __init__
    # self is the representation of the object being created.
    def __init__(self, name, breed, sex = "F"):
        # self.variable is creating a variable attached to the object
        # for example self.name is creating a variable called "name" attached
        # to the dog object. it is assigning it the value inside the "name"
        # parameter.
        self.name = name
        self.breed = breed
        self.sex = sex
...
print(dog_1, dog_2) # not very useful yet
...
print(dog_1.name) # accessing instance variables
print(dog_2.name)
